...
# RUN: %lld -lSystem -lc++ %t/test-x86_64.o -o %t/test-x86_64 --bp-compression-sort=both
...
# RUN: %lld -arch arm64 -lSystem -lc++ %t/test-arm64.o -o %t/test-arm64 --bp-compression-sort=both
